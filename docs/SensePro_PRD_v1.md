...
**Doc owner:** Vishwas (team lead) · **Status:** v1 for build · **Supersedes:** the on-board edge architecture in the earlier roadmap files (see §6).
...
|---|---|---|---|
| **A · Capture & recognition** | WS frame intake, SCRFD/ArcFace/ByteTrack pipeline, enrollment CLI | `/capture` kiosk + recognition overlay | **Vishwas (lead)** |
